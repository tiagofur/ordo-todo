    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute top-1/4 -left-32 w-96 h-96 bg-[#06B6D4]/30 rounded-full blur-3xl"
        />
        <motion.div 
          animate={{ 
            x: [0, -80, 0], 
          ...
          className="absolute top-1/3 -right-32 w-[500px] h-[500px] bg-[#EC4899]/20 rounded-full blur-3xl"
        />
        <motion.div 
          animate={{ 
            x: [0, 50, 0], 
          ...
          className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-[#F97316]/20 rounded-full blur-3xl"
        />
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#06B6D4]/10 to-[#EC4899]/10 border border-[#06B6D4]/20 mb-8"
            >
            ...
            {/* Main Heading - Fixed line-height for "g" not to be cut */}
            ...
            >
              {['pomodoro', 'ai', 'cross'].map((key) => (
                <div key={key} className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/50 text-sm">
                  <CheckCircle2 className="h-4 w-4 text-[#10B981]" />
                  <span className="text-foreground/80">{t(`features.${key}`)}</span>
                </div>
              ))}
            </motion.div>
            ...
            >
              <a href="https://ordotodo.app/register" target="_blank" rel="noreferrer">
                <Button 
                  size="lg" 
                  className="w-full sm:w-auto h-14 px-8 text-lg font-semibold bg-[#06B6D4] hover:bg-[#0891B2] text-white border-0 shadow-xl shadow-[#06B6D4]/30 transition-all duration-300 group"
                >
                  {t('cta_primary')}
              ...
              <Link href="/guide">
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="w-full sm:w-auto h-14 px-8 text-lg font-semibold border-2 hover:bg-muted/50 group"
                >
                  <Play className="mr-2 h-5 w-5 text-[#EC4899] group-hover:scale-110 transition-transform" />
                  {t('cta_secondary')}
                </Button>
              </Link>
            </motion.div>
          ...
          >
            <motion.div animate={floatingAnimation} className="relative">
              {/* Glow Effect */}
              <div className="absolute -inset-4 bg-gradient-to-r from-[#06B6D4]/20 via-[#EC4899]/20 to-[#F97316]/20 rounded-3xl blur-2xl" />
              ...
              <motion.div 
                ...
                className="absolute -left-8 top-1/4 p-4 rounded-xl bg-card border shadow-xl hidden lg:block"
              >
              ...
              <motion.div 
                ...
                className="absolute -right-6 bottom-1/3 p-4 rounded-xl bg-card border shadow-xl hidden lg:block"
              >
                <div className="flex items-center gap-3">
