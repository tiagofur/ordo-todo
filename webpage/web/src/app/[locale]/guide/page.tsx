...
export default function GuidePage() {
  ...
  return (
    <div>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-[#06B6D4]/20 via-[#EC4899]/20 to-[#F97316]/20 rounded-2xl" />
        <img 
      ...
      {/* Tips */}
      <div className="not-prose p-6 rounded-xl bg-gradient-to-r from-[#10B981]/10 to-[#06B6D4]/10 border border-[#10B981]/20 mb-12">
