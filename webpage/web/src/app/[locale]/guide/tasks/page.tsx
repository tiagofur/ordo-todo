    ...
    <div>
      ...
      <div className="not-prose p-5 rounded-xl border bg-card my-6">
        <div className="flex items-center gap-4 mb-4">
          <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-[#F97316] to-[#EC4899] flex items-center justify-center">
      ...
      {/* Tip */}
      <div className="not-prose p-6 rounded-xl bg-gradient-to-r from-[#F97316]/10 to-[#EC4899]/10 border border-[#F97316]/20 mt-8">
        <p className="text-sm text-muted-foreground">
