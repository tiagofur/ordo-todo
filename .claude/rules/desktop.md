# Desktop Rules (Electron)

**Specific rules for `apps/desktop/` (Electron + Vite)**
...
4.  **Handle State**: Keep the "Source of Truth" in the Main process (or a dedicated store) for app-level state.
...
Manage IPC channels using constant enums or TypeScript types.
