...
export function UserProfileCard({ user, onUpdateUsername, onUpdateProfile, showEditButton = true, className, variant = 'default', usernameValidation = {
    isLoading: false,
    isValid: true,
    isAvailable: true
}, onValidateUsername, }) {
