...
var use_username_validation_exports = {};
__export(use_username_validation_exports, {
  generateUsernameSuggestions: () => generateUsernameSuggestions,
  useUsernameValidation: () => useUsernameValidation
});
module.exports = __toCommonJS(use_username_validation_exports);
...
function useUsernameValidation({
  ...
  const [validationResult, setValidationResult] = (0, import_react.useState)({
    isValid: false,
    isAvailable: null,
    message: "",
    isLoading: false
  });
  const [lastCheckedUsername, setLastCheckedUsername] = (0, import_react.useState)("");
  const usernameRegex = /^[a-z0-9_-]+$/;
  const validateFormat = (0, import_react.useCallback)((username) => {
  ...
  const checkUsernameAvailability = (0, import_react.useCallback)(
    async (username) => {
  ...
  const validateUsername = (0, import_react.useCallback)(
    async (username) => {
  ...
  const resetValidation = (0, import_react.useCallback)(() => {
    setValidationResult({
      isValid: false,
      isAvailable: null,
      message: "",
...
//# sourceMappingURL=use-username-validation.js.map