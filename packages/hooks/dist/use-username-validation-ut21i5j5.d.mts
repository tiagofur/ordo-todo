import { OrdoApiClient, TaskShareResponse, PublicTaskResponse, Attachment, Notification, UnreadCountResponse } from '@ordo-todo/api-client';
...
declare function useUsernameValidation({ apiClient, minLength, maxLength, debounceMs, currentUsername, }: UseUsernameValidationOptions): {
    validationResult: UsernameValidationResult;
    validateUsername: (username: string) => Promise<void>;
    resetValidation: () => void;
};
declare function generateUsernameSuggestions(baseName: string): string[];

export { type ApiClient as A, type CreateHooksConfig as C, generateUsernameSuggestions as g, useUsernameValidation as u };
