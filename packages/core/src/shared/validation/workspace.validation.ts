...
export const workspaceBaseSchema = z.object({
    name: z
        ...
        .max(WORKSPACE_LIMITS.NAME_MAX_LENGTH, `Workspace name must be less than ${WORKSPACE_LIMITS.NAME_MAX_LENGTH} characters`),
    description: z
        .string()
        .max(WORKSPACE_LIMITS.DESCRIPTION_MAX_LENGTH, `Description must be less than ${WORKSPACE_LIMITS.DESCRIPTION_MAX_LENGTH} characters`)
        .optional(),
...
export const workspaceSettingsSchema = z.object({
    ...
    defaultTaskStatus: z.enum(["TODO", "IN_PROGRESS", "IN_REVIEW", "DONE", "CANCELLED"]).optional(),
