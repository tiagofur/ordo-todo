...
## 🚧 Sprint Actual: Mobile Parity & OAuth (ACTIVO)

**Objetivo:** Implementar autenticación OAuth y mejorar paridad features Web → Mobile.

### OAuth Implementation ✅

- [x] Instalar dependencias OAuth (passport, passport-google-oauth20, passport-github2)
- [x] Crear Google OAuth Strategy
- [x] Crear GitHub OAuth Strategy
- [x] Implementar `oauthLogin()` en AuthService
- [x] Actualizar UserRepository con métodos OAuth (findByProvider, linkOAuthAccount, create)
- [x] Crear endpoints OAuth (/auth/google, /auth/github, /auth/google/callback, /auth/github/callback)
- [x] Actualizar AuthModule con estrategias OAuth
- [x] Instalar expo-auth-session y expo-web-browser en mobile
- [x] Crear funciones OAuth (signInWithGoogle, signInWithGitHub)
- [x] Crear componente OAuthButton
- [x] Agregar botones Google/GitHub a AuthForm
- [x] Crear pantalla de callback OAuth
- [x] Configurar scheme OAuth en app.json
...
- [x] Crear análisis de gap Web vs Mobile (docs/mobile/WEB_VS_MOBILE_GAP_ANALYSIS.md)
- [x] Identificar 60+ features comparados entre Web y Mobile
- [x] Priorizar features en fases (Phase 1: Core Productivity, Phase 2: Enhanced, Phase 3: Polish)
- [x] Implementar Tags page en Mobile (screens/(internal)/tags.tsx)
- [x] Implementar Tasks por período (Today/Week/Month) en Mobile (screens/(internal)/tasks-period.tsx)
...
## 🚧 Sprint Anterior: Quick Wins & Polish
...
## 🔧 Sprint 8: Integración de Paquetes Compartidos (COMPLETADO)
...
| ----------------------------- | --------- | -------------- |
| Autenticación OAuth (Mobile)  | Alta      | 🟡 En Progreso |
