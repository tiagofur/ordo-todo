...
gantt
    ...
    section Fase 1 (Q1)
    Smart Dates (Start/Scheduled)    :2025-01, 3w
    Habit Tracker MVP               :2025-01, 6w
    
    section Fase 2 (Q2)
    Time Blocking Calendar          :2025-03, 5w
    OKRs/Goals System               :2025-04, 6w
    
    section Fase 3 (Q3)
    Custom Fields                   :2025-06, 5w
    AI Enhancements                 :2025-07, 4w
```
