import { PrismaClient, DailyMetrics as PrismaDailyMetrics } from "@prisma/client";
...
export class PrismaAnalyticsRepository implements AnalyticsRepository {
    ...
    async getRange(userId: string, startDate: Date, endDate: Date): Promise<DailyMetrics[]> {
