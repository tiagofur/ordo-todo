        ...
        <div className="p-6 space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-3">
              <Label className="text-sm font-medium text-foreground">Tipo de Workspace</Label>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="Ej: Mi Empresa, Personal, etc."
              />
              {errors.name && (
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Descripción opcional del espacio de trabajo..."
              />
            </div>
