...
export function HabitCelebration({ show, onComplete, xp, streak }: HabitCelebrationProps) {
...
// Hook for triggering celebration
export function useHabitCelebration() {
  ...
  const celebrate = (xp?: number, streak?: number) => {
    setCelebrationData({ show: true, xp, streak });
  };

  const dismiss = () => {
    setCelebrationData({ show: false });
  };
