      ...
      <div className="space-y-6">
        ...
        {!selectedWorkspaceId ? (
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2">Selecciona un Workspace</h3>
            <p className="text-muted-foreground mb-6 max-w-md">
              Para empezar, selecciona un workspace de la lista para ver sus proyectos.
            </p>
          </motion.div>
        ) : isLoading ? (
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2">No hay proyectos todavía</h3>
            <p className="text-muted-foreground mb-6 max-w-md">
