    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Organiza tus proyectos y tareas en diferentes espacios de trabajo
          </p>
        </div>
        <button
      ...
      {isLoading ? (
        ...
        >
          ...
          <h3 className="text-xl font-semibold mb-2">No tienes workspaces</h3>
          <p className="text-muted-foreground mb-6 max-w-md">
            Crea tu primer workspace para comenzar a organizar tus proyectos y tareas
          </p>
          <button
            onClick={() => setShowCreateDialog(true)}
