...
export default function ProfilePage() {
  ...
  async function handleSaveAiPreferences() {
    try {
      await updatePreferences.mutateAsync(aiPreferences);
  ...
  async function handleSavePrivacyPreferences() {
    try {
      await updatePreferences.mutateAsync(privacyPreferences);
        ...
        <TabsContent value="ai">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-end">
                <Button onClick={handleSaveAiPreferences} disabled={updatePreferences.isPending}>
                  <Save className="h-4 w-4 mr-2" />
                  {updatePreferences.isPending ? "Saving..." : "Save AI Preferences"}
                </Button>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="privacy">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-end">
                <Button onClick={handleSavePrivacyPreferences} disabled={updatePreferences.isPending}>
                  <Save className="h-4 w-4 mr-2" />
                  {updatePreferences.isPending ? "Saving..." : "Save Privacy Settings"}
                </Button>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="p-4 border rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" onClick={handleExportData} disabled={exportData.isPending}>
                    {exportData.isPending ? "Exporting..." : "Request Export"}
                  </Button>
                </div>
              </div>
