...
export default function ObjectiveDetailPage() {
    ...
    if (isLoading) return <div className="p-6"><Skeleton className="h-96 w-full max-w-5xl mx-auto rounded-3xl" /></div>;
    ...
    return (
        <div className="flex bg-background h-full flex-col p-6 max-w-5xl mx-auto w-full transition-all">
            <Button 
                variant="ghost" 
                onClick={() => router.push('/goals')} 
                className="w-fit mb-6 pl-0 hover:bg-transparent hover:text-primary -ml-2"
            >
