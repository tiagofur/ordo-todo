...
import { TaskHealthBadge } from "@/components/task/task-health-badge";
...
export function KanbanTaskCard({ task, index = 0 }: KanbanTaskCardProps) {
  ...
  const priorityConfig = {
    LOW: { label: t('TaskCard.priority.LOW'), color: "text-gray-500", bg: "bg-gray-500/10" },
    MEDIUM: { label: t('TaskCard.priority.MEDIUM'), color: "text-blue-500", bg: "bg-blue-500/10" },
    HIGH: { label: t('TaskCard.priority.HIGH'), color: "text-orange-500", bg: "bg-orange-500/10" },
    URGENT: { label: t('TaskCard.priority.URGENT'), color: "text-red-500", bg: "bg-red-500/10" },
  };
