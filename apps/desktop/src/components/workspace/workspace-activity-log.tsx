    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h3 className="text-lg font-semibold text-foreground mb-1">
          {t('WorkspaceActivityLog.empty.title')}
        </h3>
        <p className="text-sm text-muted-foreground max-w-sm">
          {t('WorkspaceActivityLog.empty.description')}
        </p>
      </div>
    );
  }
                ...
                <div className="flex-1">
                  ...
                  {log.actorId && (
                    <div className="flex items-center gap-1.5 mt-1 text-xs text-muted-foreground">
                      ...
                      <span>{t('WorkspaceActivityLog.by')} User {log.actorId.slice(0, 8)}</span>
                    </div>
                  )}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between pt-4 border-t border-border">
          <p className="text-sm text-muted-foreground">
            {t('WorkspaceActivityLog.pagination.showing', {
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">
              {t('WorkspaceActivityLog.pagination.page', { current: page + 1, total: totalPages })}
            </span>
