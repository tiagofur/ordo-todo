...
import { useAIInsights } from "@/hooks/api";
        ...
        <CardContent>
          <div className="text-center py-4">
            ...
            <p className="text-sm text-muted-foreground">
              {t("noInsights", "No hay insights en este momento")}
            </p>
            <p className="text-xs text-muted-foreground/70 mt-1">
              {t("aiSuggestion", "Continúa trabajando y la IA te dará sugerencias")}
            </p>
          </div>
        </CardContent>
      </Card>
    ...
    <Card className={cn("relative overflow-hidden", className)}>
      ...
      <CardContent className="relative">
        ...
        {insights.length > maxInsights && (
          ...
          >
            {t("viewAllInsights", "Ver todos los insights")} ({insights.length})
            <ChevronRight className="h-3 w-3" />
          </button>
        )}
      </CardContent>
