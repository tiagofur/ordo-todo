var Em = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports);
import zt, { nativeImage as Su, Tray as Tu, app as Ne, Menu as Io, globalShortcut as zi, shell as ca, Notification as bu, ipcMain as de, screen as bh, BrowserWindow as Lo, dialog as vm } from "electron";
...
import _n from "os";
import wm from "better-sqlite3";
import Sm from "constants";
import En from "stream";
import Wi from "child_process";
import Rh from "tty";
import Pr from "url";
import Tm from "string_decoder";
import Ah from "zlib";
import bm from "http";
var iE = Em(() => {
  let wt = null;
  ...
  function qo(e, t) {
    if (!wt) return;
    Nh = t;
    const i = Am(t.mode), r = Om(t.mode), u = t.timerActive ? `Ordo-Todo - ${r} ${t.timeRemaining}` : "Ordo-Todo";
    wt.setToolTip(u);
  ...
  function Ih() {
    ...
    const e = Tt, t = yn, i = Gm(), r = Vm(), u = Ym(), n = {
  ...
  function Jm() {
    ...
    const e = $e, t = vn(), i = Ih(), r = Xm(), u = Wm(), n = Km();
...
` : "" }, this._extScope = P, this._scope = new i.Scope({ parent: P }), this._nodes = [new E()];
  ...
  function Ji() {
    ...
    const e = Ie(), t = kh(), i = rg(), r = /* @__PURE__ */ new Set([
      "type",
      "format",
      "pattern",
      "maxLength",
  ...
  function Qi() {
    ...
    const e = Qm(), t = Xi(), i = $h(), r = Xi(), u = Zm(), n = eg(), s = tg(), d = Oe(), a = Xt(), l = Ji(), o = Ie(), f = Ki();
    function c(q) {
      if (R(q) && (S(q), b(q))) {
        h(q);
        return;
  ...
  const ng = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", ig = "Meta-schema for $data reference (JSON AnySchema extension proposal)", ag = "object", sg = ["$data"], og = { $data: { type: "string", anyOf: [{ format: "relative-json-pointer" }, { format: "json-pointer" }] } }, ug = !1, lg = {
    $id: ng,
    description: ig,
    type: ag,
    required: sg,
  ...
  function dg() {
    ...
    yl = 1;
    const { normalizeIPv6: e, removeDotSegments: t, recomposeAuthority: i, normalizeComponentEncoding: r, isIPv4: u, nonSimpleDomain: n } = Lh(), { SCHEMES: s, getSchemeHandler: d } = cg();
    function a(h, _) {
  ...
  function hg() {
    return El || (El = 1, (function(e) {
      ...
      const r = Mo(), u = Zi(), n = Dh(), s = jo(), d = Oe(), a = Ji(), l = Xi(), o = Ie(), f = lg, c = fg(), p = (F, x) => new RegExp(F, x);
      p.code = "new RegExp";
  ...
  function Ng() {
    ...
    const e = yg(), t = _g(), i = vg(), r = wg(), u = Sg(), n = Tg(), s = bg(), d = Rg(), a = Ag(), l = Og(), o = [
      // number
      e.default,
      t.default,
      // string
  ...
  function Bg() {
    ...
    const e = Fh(), t = Pg(), i = Uh(), r = Cg(), u = Ig(), n = Dg(), s = $g(), d = qh(), a = kg(), l = Lg(), o = Fg(), f = Ug(), c = qg(), p = xg(), y = Mg(), E = jg();
    function h(_ = !1) {
      const g = [
        // any
        o.default,
  ...
  function zg() {
    ...
    const e = gg(), t = Ng(), i = Bg(), r = Gg(), u = Vg(), n = [
      e.default,
      t.default,
      (0, i.default)(),
      r.default,
  ...
  function Xg() {
    ...
    const e = Oe(), t = Yg(), i = jo(), r = Zi(), u = Ie(), s = {
  ...
  const Wg = "http://json-schema.org/draft-07/schema#", Kg = "http://json-schema.org/draft-07/schema#", Jg = "Core schema meta-schema", Qg = { schemaArray: { type: "array", minItems: 1, items: { $ref: "#" } }, nonNegativeInteger: { type: "integer", minimum: 0 }, nonNegativeIntegerDefault0: { allOf: [{ $ref: "#/definitions/nonNegativeInteger" }, { default: 0 }] }, simpleTypes: { enum: ["array", "boolean", "integer", "null", "number", "object", "string"] }, stringArray: { type: "array", items: { type: "string" }, uniqueItems: !0, default: [] } }, Zg = ["object", "boolean"], ey = { $id: { type: "string", format: "uri-reference" }, $schema: { type: "string", format: "uri" }, $ref: { type: "string", format: "uri-reference" }, $comment: { type: "string" }, title: { type: "string" }, description: { type: "string" }, default: !0, readOnly: { type: "boolean", default: !1 }, examples: { type: "array", items: !0 }, multipleOf: { type: "number", exclusiveMinimum: 0 }, maximum: { type: "number" }, exclusiveMaximum: { type: "number" }, minimum: { type: "number" }, exclusiveMinimum: { type: "number" }, maxLength: { $ref: "#/definitions/nonNegativeInteger" }, minLength: { $ref: "#/definitions/nonNegativeIntegerDefault0" }, pattern: { type: "string", format: "regex" }, additionalItems: { $ref: "#" }, items: { anyOf: [{ $ref: "#" }, { $ref: "#/definitions/schemaArray" }], default: !0 }, maxItems: { $ref: "#/definitions/nonNegativeInteger" }, minItems: { $ref: "#/definitions/nonNegativeIntegerDefault0" }, uniqueItems: { type: "boolean", default: !1 }, contains: { $ref: "#" }, maxProperties: { $ref: "#/definitions/nonNegativeInteger" }, minProperties: { $ref: "#/definitions/nonNegativeIntegerDefault0" }, required: { $ref: "#/definitions/stringArray" }, additionalProperties: { $ref: "#" }, definitions: { type: "object", additionalProperties: { $ref: "#" }, default: {} }, properties: { type: "object", additionalProperties: { $ref: "#" }, default: {} }, patternProperties: { type: "object", additionalProperties: { $ref: "#" }, propertyNames: { format: "regex" }, default: {} }, dependencies: { type: "object", additionalProperties: { anyOf: [{ $ref: "#" }, { $ref: "#/definitions/stringArray" }] } }, propertyNames: { $ref: "#" }, const: !0, enum: { type: "array", items: !0, minItems: 1, uniqueItems: !0 }, type: { anyOf: [{ $ref: "#/definitions/simpleTypes" }, { type: "array", items: { $ref: "#/definitions/simpleTypes" }, minItems: 1, uniqueItems: !0 }] }, format: { type: "string" }, contentMediaType: { type: "string" }, contentEncoding: { type: "string" }, if: { $ref: "#" }, then: { $ref: "#" }, else: { $ref: "#" }, allOf: { $ref: "#/definitions/schemaArray" }, anyOf: { $ref: "#/definitions/schemaArray" }, oneOf: { $ref: "#/definitions/schemaArray" }, not: { $ref: "#" } }, ty = {
    $schema: Wg,
    $id: Kg,
    title: Jg,
    definitions: Qg,
  ...
  function xh() {
    return ac || (ac = 1, (function(e, t) {
      ...
      const i = hg(), r = zg(), u = Xg(), n = ty, s = ["/properties"], d = "http://json-schema.org/draft-07/schema";
  ...
  function iy() {
    return uc || (uc = 1, (function(e, t) {
      ...
      const i = ry(), r = ny(), u = Oe(), n = new u.Name("fullFormats"), s = new u.Name("fastFormats"), d = (l, o = { keywords: !0 }) => {
        if (Array.isArray(o))
...
${l}`, u = Object.getOwnPropertyDescriptor(Function.prototype, "toString"), n = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name"), s = (a, l, o) => {
  ...
  function At() {
    ...
    ns = t;
    const i = vy(), r = new i(), u = Ho(), n = na(), s = ta(), d = nt(), {
      safeRe: a,
      t: l,
  ...
  function Wo() {
    if (td) return ys;
    td = 1;
    const e = wn(), t = ea(), i = nt(), r = Mh(), u = Cr(), n = oy(), s = uy(), d = ly(), a = cy(), l = dy(), o = fy(), f = hy(), c = py(), p = Rt(), y = my(), E = gy(), h = Go(), _ = yy(), g = _y(), w = ra(), b = Vo(), R = jh(), v = Bh(), S = zo(), O = Yo(), T = Hh(), $ = Ey(), k = na(), U = At(), V = ia(), L = wy(), B = Sy(), te = Ty(), j = by(), H = Ry(), Y = Xo(), F = Ay(), x = Oy(), X = Ny(), G = Py(), P = Cy();
    return ys = {
      parse: u,
      valid: n,
      clean: s,
  ...
  function Dy() {
    ...
    nd = 1;
    const e = Iy(), t = /* @__PURE__ */ new WeakMap(), i = (r, u = {}) => {
  ...
  function $y() {
    return id || (id = 1, (function(e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });
      const o = yn, f = Tt, c = $e, p = Nr, y = Fo, E = Uo, h = Lm(), _ = Bm(), g = Hm(), w = Jm(), b = xh(), R = iy(), v = sy(), S = Wo(), O = Dy(), T = "aes-256-cbc", $ = () => /* @__PURE__ */ Object.create(null), k = (j) => j != null;
      let U = "";
      try {
  ...
  function ky() {
    if (ad) return _s;
    ad = 1;
    const e = $e, { app: t, ipcMain: i, ipcRenderer: r, shell: u } = zt, n = $y();
    let s = !1;
    const d = () => {
      if (!i || !t)
...
`;
  ...
  function Gh() {
    ...
    return Ru.existsSync(t) || Ru.mkdirSync(t, { recursive: !0 }), ct = new wm(e, {
      // Enable WAL mode for better concurrent read performance
      // verbose: console.log // Uncomment for debugging
    }), ct.pragma("journal_mode = WAL"), ct.pragma("foreign_keys = ON"), ct.pragma("synchronous = NORMAL"), xy(ct), console.log("[Database] Database initialized successfully"), ct;
  }
  function xy(e) {
    e.exec(Uy);
    const t = e.prepare(`
  ...
  function o0() {
    const e = a0("last_sync_time");
    return e ? parseInt(e, 10) : null;
  }
  function u0(e) {
    s0("last_sync_time", e.toString());
  }
  function l0(e, t) {
    const i = xe(), r = Jo(e);
    r && i.prepare(`
  ...
  function f0(e, t) {
    pn = e, mn = t, Xe.lastSyncTime = o0(), Yh(), console.log("[SyncEngine] Initialized");
  }
  function h0(e) {
  ...
  async function Qo() {
    ...
    try {
      Xe.status = "syncing", Xe.error = void 0, Or(), console.log("[SyncEngine] Starting sync..."), await g0(), await _0();
      const e = Date.now();
      u0(e), Xe.lastSyncTime = e, Xe.status = "idle", Yh(), console.log("[SyncEngine] Sync completed successfully");
    } catch (e) {
  ...
  async function g0() {
    ...
    for (const t of e)
      try {
        r0(t.id), Xe.currentOperation = `Syncing ${t.entity_type} ${t.operation}`, Or(), await y0(t) && n0(t.id);
      } catch (i) {
        const r = i instanceof Error ? i.message : "Unknown error";
        console.error(`[SyncEngine] Failed to push ${t.entity_type}:${t.entity_id}:`, r), i0(t.id, r);
      }
  ...
  async function y0(e) {
    ...
    if (e.operation === "create" || e.operation === "update") {
      ...
      d0(e.entity_type, e.entity_id, u.updatedAt ? new Date(u.updatedAt).getTime() : Date.now());
    }
    return !0;
  }
  async function _0() {
  ...
  function T0(e) {
    try {
      Gh(), f0(e, process.env.VITE_API_URL || "http://localhost:3001/api/v1"), console.log("[IPC] Database and Sync Engine initialized");
    } catch (t) {
    ...
    }), de.handle("shortcuts:getAll", () => Cm()), de.handle("shortcuts:getDefaults", () => Tr), de.handle("shortcuts:update", (t, i, r) => Im(e, i, r)), de.handle("shortcuts:reset", () => (Ph(e, Tr), Ht.set("settings.shortcuts", Tr), Tr)), de.handle("store:get", (t, i) => Ht.get(i)), de.handle("store:set", (t, i, r) => (Ht.set(i, r), !0)), de.handle("store:delete", (t, i) => (Ht.delete(i), !0)), de.handle("store:clear", () => (Ht.clear(), !0)), de.handle("app:getVersion", () => Ne.getVersion()), de.handle("app:getName", () => Ne.getName()), de.handle("app:getPath", (t, i) => Ne.getPath(i)), de.handle("app:isPackaged", () => Ne.isPackaged), de.on("timer:stateUpdate", (t, i) => {
      Au(e, i);
    }), de.handle("db:task:create", (t, i) => jy(i)), de.handle("db:task:update", (t, i, r) => By(i, r)), de.handle("db:task:delete", (t, i, r) => Hy(i, r !== !1)), de.handle("db:task:getById", (t, i) => Do(i)), de.handle("db:task:getByWorkspace", (t, i) => Gy(i)), de.handle("db:task:getByProject", (t, i) => Vy(i)), de.handle("db:task:getPending", (t, i) => zy(i)), de.handle("db:task:getUnsynced", () => Yy()), de.handle("db:workspace:create", (t, i) => Xy(i)), de.handle("db:workspace:getAll", () => Wy()), de.handle("db:workspace:getById", (t, i) => Ky(i)), de.handle("db:project:create", (t, i) => Jy(i)), de.handle("db:project:getByWorkspace", (t, i) => Qy(i)), de.handle("db:session:create", (t, i) => Zy(i)), de.handle("db:session:getByWorkspace", (t, i, r, u) => e0(i, r, u)), de.handle("sync:setAuthToken", (t, i) => (h0(i), !0)), de.handle("sync:startAuto", (t, i) => (p0(i), !0)), de.handle("sync:stopAuto", () => (zh(), !0)), de.handle("sync:setOnlineStatus", (t, i) => (m0(i), !0)), de.handle("sync:getState", () => sd()), de.handle("sync:force", async () => (await w0(), sd())), de.handle("sync:getQueueStats", () => Vh());
  }
  function ld() {
    return Ht;
  }
  function b0() {
    de.removeAllListeners(), xo(), S0(), My();
  }
  const Vi = new Ko({
    defaults: {
      windowState: {
  ...
  function F0() {
    de.handle("timer-window:show", () => {
      ...
      cd();
    }), de.handle("timer-window:toggle", () => (I0(), dd())), de.handle("timer-window:isVisible", () => dd()), de.handle("timer-window:setPosition", (e, t, i) => {
      k0(t, i);
    }), de.handle("timer-window:getPosition", () => L0()), de.handle("timer-window:action", (e, t) => {
  ...
  function B0() {
    if (pd) return ws;
    pd = 1;
    var e = Sm, t = process.cwd, i = null, r = process.env.GRACEFUL_FS_PLATFORM || process.platform;
  ...
  function ot() {
    if (yd) return $i;
    yd = 1;
    var e = Tt, t = B0(), i = H0(), r = G0(), u = yn, n, s;
...
GFS4: `), console.error(h);
  ...
  function z0() {
    if (vd) return ki;
    vd = 1;
    const e = /* @__PURE__ */ Dr(), { checkPath: t } = /* @__PURE__ */ V0(), i = (r) => {
      const u = { mode: 511 };
  ...
  function Nt() {
    if (wd) return Rs;
    wd = 1;
    const e = dt().fromPromise, { makeDir: t, makeDirSync: i } = /* @__PURE__ */ z0(), r = e(t);
    return Rs = {
      mkdirs: r,
      mkdirsSync: i,
      // alias
  ...
  function sa() {
    if (Pd) return $s;
    Pd = 1;
    const e = ot(), t = dt().fromCallback, i = /* @__PURE__ */ W0();
    function r(n, s) {
  ...
  function t_() {
    if (Ld) return xs;
    Ld = 1;
    const e = dt().fromCallback, t = $e, i = /* @__PURE__ */ Dr(), r = /* @__PURE__ */ Nt(), u = r.mkdirs, n = r.mkdirsSync, s = /* @__PURE__ */ Z0(), d = s.symlinkPaths, a = s.symlinkPathsSync, l = /* @__PURE__ */ e_(), o = l.symlinkType, f = l.symlinkTypeSync, c = fr().pathExists, { areIdentical: p } = /* @__PURE__ */ $r();
    function y(_, g, w, b) {
  ...
  function r_() {
    if (Fd) return Ms;
    Fd = 1;
    const { createFile: e, createFileSync: t } = /* @__PURE__ */ J0(), { createLink: i, createLinkSync: r } = /* @__PURE__ */ Q0(), { createSymlink: u, createSymlinkSync: n } = /* @__PURE__ */ t_();
    return Ms = {
      // file
      createFile: e,
      createFileSync: t,
...
`, finalEOL: u = !0, replacer: n = null, spaces: s } = {}) {
  ...
  function o_() {
    if (Hd) return Ys;
    Hd = 1;
    const e = dt().fromPromise, t = /* @__PURE__ */ i_();
    return t.outputJson = e(/* @__PURE__ */ a_()), t.outputJsonSync = /* @__PURE__ */ s_(), t.outputJSON = t.outputJson, t.outputJSONSync = t.outputJsonSync, t.writeJSON = t.writeJson, t.writeJSONSync = t.writeJsonSync, t.readJSON = t.readJson, t.readJSONSync = t.readJsonSync, Ys = t, Ys;
  }
  var Xs, Gd;
  function u_() {
    if (Gd) return Xs;
  ...
  function Jh() {
    ...
    Jd = 1;
    function e(t) {
      r.debug = r, r.default = r, r.coerce = l, r.disable = d, r.enable = n, r.enabled = a, r.humanize = d_(), r.destroy = o, Object.keys(t).forEach((f) => {
        r[f] = t[f];
  ...
  function p_() {
    if (ef) return ro;
    ef = 1;
    const e = _n, t = Rh, i = h_(), { env: r } = process;
    let u;
...
`).map((p) => p.trim()).join(" ");
  ...
  var rf;
  function g_() {
    return rf || (rf = 1, typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Fi.exports = f_() : Fi.exports = m_()), Fi.exports;
  }
  var Gr = {}, nf;
  function Qh() {
    if (nf) return Gr;
  ...
  function y_() {
    ...
    const e = Nr, t = g_(), i = Tt, r = En, u = Pr, n = ru(), s = oa(), d = Qh(), a = (0, t.default)("electron-builder");
    function l(v, S = null) {
...
\r`;
  ...
  function A_() {
    if (Ff) return ji;
    Ff = 1;
    var e = Sn(), t = Tn(), i = R_(), r = nu(), u = Object.prototype.hasOwnProperty, n = 1, s = 2, d = 3, a = 4, l = 1, o = 2, f = 3, c = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, p = /[\x85\u2028\u2029]/, y = /[,\[\]\{\}]/, E = /^(?:!|!!|![a-z\-]+!)$/i, h = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
    function _(m) {
...
` : "";
  ...
  function C_() {
    ...
    const e = Nr, t = Tt, i = P_(), r = /* @__PURE__ */ Wt(), u = $e;
    let n = class {
      constructor(l) {
...
${_}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
  ...
  function q_() {
    ...
    const e = Qe(), t = L_(), i = gp(), r = yp(), u = F_(), n = U_();
    function s(a) {
...
`);
  ...
  function Ep() {
    ...
    const e = Qe(), t = /* @__PURE__ */ Wt(), i = Tt, r = _p(), u = Pr, n = au(), s = x_(), d = M_();
    let a = class {
  ...
  function su() {
    ...
    const e = Qe(), t = Nr, i = _n, r = Uo, u = /* @__PURE__ */ Wt(), n = iu(), s = N_(), d = $e, a = Wo(), l = C_(), o = D_(), f = $_(), c = gp(), p = q_(), y = Ah, E = hr(), h = j_(), _ = pr();
  ...
  function Eh() {
    ...
    const e = Qe(), t = /* @__PURE__ */ Wt(), i = Tt, r = $e, u = bm, n = su(), s = mt(), d = Wi, a = Nr;
  ...
  function Sh() {
    ...
    const e = Qe(), t = $e, i = kr(), r = wp(), u = pr(), n = mt(), s = /* @__PURE__ */ Wt(), d = B_(), a = Pr;
...
`) : void 0
  ...
  async function Y_(e) {
    ...
    const { response: t } = await vm.showMessageBox(Vt, {
      type: "info",
  ...
  function X_() {
    de.handle("auto-update:check", async (e, t) => (await ko(t ?? !0), Ar)), de.handle("auto-update:download", async () => (await z_(), Ar)), de.handle("auto-update:install", () => {
      Sp();
  ...
  function eE() {
    ...
    e.openAtLogin !== t && Yt.set("autoLaunch.enabled", e.openAtLogin), tE(), console.log("[AutoLaunch] Initialized:", {
      enabled: e.openAtLogin,
      wasOpenedAtLogin: cu()
    });
  }
  function tE() {
    de.handle("auto-launch:isEnabled", () => ou()), de.handle("auto-launch:getSettings", () => J_()), de.handle("auto-launch:enable", (e, t) => uu(t ?? !0)), de.handle("auto-launch:disable", () => Tp()), de.handle("auto-launch:toggle", () => Q_()), de.handle("auto-launch:setStartMinimized", (e, t) => (Z_(t), !0)), de.handle("auto-launch:wasStartedAtLogin", () => cu());
  }
  function rE() {
  ...
  function Rp() {
    ...
    }), A0(Ye), e.isMaximized && Ye.maximize(), T0(Ye), Dm(Ye), Nm(Ye), P0(Ye), F0(), M0(Ye), V_(Ye), eE(), Ph(Ye), Ye.on("close", (i) => {
    ...
    Ye.once("ready-to-show", () => {
      !ld().get("settings.startMinimized", !1) && !t && Ye?.show(), x0();
