...
describe('WorkspacesController', () => {
    ...
    beforeEach(async () => {
        ...
        workspacesService = module.get<WorkspacesService>(WorkspacesService) as jest.Mocked<WorkspacesService>;
    });
    ...
    describe('create', () => {
        it('should create a new workspace', async () => {
            const createDto = { name: 'New Workspace', description: 'Test workspace' };
            const mockWorkspace = { id: 'ws-123', ...createDto, ownerId: mockUser.id };
            workspacesService.create.mockResolvedValue(mockWorkspace as any);

            const result = await controller.create(createDto, mockUser);

            expect(workspacesService.create).toHaveBeenCalledWith(mockUser.id, createDto);
    ...
    describe('findOne', () => {
        it('should return workspace by id', async () => {
            ...
            expect(workspacesService.findById).toHaveBeenCalledWith('ws-123', mockUser.id);
            expect(result).toEqual(mockWorkspace);
        });
    });
    ...
    describe('update', () => {
        it('should update workspace', async () => {
            ...
            expect(workspacesService.update).toHaveBeenCalledWith('ws-123', mockUser.id, updateDto);
    ...
    describe('remove', () => {
        it('should delete workspace', async () => {
            ...
            expect(workspacesService.delete).toHaveBeenCalledWith('ws-123', mockUser.id);
        });
    });
    ...
    describe('getMembers', () => {
        it('should return workspace members', async () => {
            ...
            expect(workspacesService.getMembers).toHaveBeenCalledWith('ws-123', mockUser.id);
    ...
    describe('addMember', () => {
        it('should add member to workspace', async () => {
            ...
            const result = await controller.addMember('ws-123', addMemberDto, mockUser);

            expect(workspacesService.addMember).toHaveBeenCalledWith('ws-123', mockUser.id, addMemberDto);
    ...
    describe('updateMember', () => {
        it('should update member role', async () => {
            ...
            const result = await controller.updateMember('ws-123', 'user-456', updateDto, mockUser);

            expect(workspacesService.updateMember).toHaveBeenCalledWith('ws-123', mockUser.id, 'user-456', updateDto);
    ...
    describe('removeMember', () => {
        it('should remove member from workspace', async () => {
            ...
            expect(workspacesService.removeMember).toHaveBeenCalledWith('ws-123', mockUser.id, 'user-456');
        });
    });
});
