...
describe('UsersController', () => {
    ...
    describe('updateProfile', () => {
        it('should update user profile', async () => {
            ...
            const result = await controller.updateProfile(mockUser, updateData as any);

            expect(usersService.updateProfile).toHaveBeenCalledWith(mockUser.email, updateData);
    ...
    describe('updatePreferences', () => {
        it('should update user preferences', async () => {
            ...
            usersService.updatePreferences.mockResolvedValue(updatedPreferences as any);

            const result = await controller.updatePreferences(mockUser, preferencesData as any);

            expect(usersService.updatePreferences).toHaveBeenCalledWith(mockUser.email, preferencesData);
