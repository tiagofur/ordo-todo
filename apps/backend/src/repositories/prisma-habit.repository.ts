...
export class PrismaHabitRepository implements IHabitRepository {
    ...
    async update(id: string, data: Partial<HabitProps>): Promise<Habit> {
        ...
        if (data.frequency !== undefined) updateData.frequency = data.frequency as PrismaHabitFrequency;
        if (data.targetDaysOfWeek !== undefined) updateData.targetDaysOfWeek = data.targetDaysOfWeek;
        ...
        if (data.timeOfDay !== undefined) updateData.timeOfDay = data.timeOfDay as PrismaTimeOfDay;
        ...
        if (data.totalCompletions !== undefined) updateData.totalCompletions = data.totalCompletions;
    ...
    private calculateExpectedCompletions(habit: PrismaHabit, days: number): number {
