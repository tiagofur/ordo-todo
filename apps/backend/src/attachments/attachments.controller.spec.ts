...
describe('AttachmentsController', () => {
  ...
  describe('findByTask', () => {
    it('should return attachments for task', async () => {
      ...
      expect(attachmentsService.findByTask).toHaveBeenCalledWith(
        'task-123',
        mockUser.id,
      );
  ...
  describe('findOne', () => {
    it('should return attachment by id', async () => {
      ...
      expect(attachmentsService.findById).toHaveBeenCalledWith(
        'att-123',
        mockUser.id,
      );
      expect(result).toEqual(mockAttachment);
  ...
  describe('remove', () => {
    it('should delete attachment', async () => {
      ...
      expect(attachmentsService.delete).toHaveBeenCalledWith(
        'att-123',
        mockUser.id,
      );
    });
  ...
  describe('download', () => {
    it('should return download URL', async () => {
      ...
      expect(attachmentsService.getDownloadUrl).toHaveBeenCalledWith(
        'att-123',
        mockUser.id,
      );
