...
describe('TemplatesController', () => {
    ...
    beforeEach(async () => {
        ...
        templatesService = module.get<TemplatesService>(TemplatesService) as jest.Mocked<TemplatesService>;
    });
    ...
    describe('create', () => {
        it('should create a new template', async () => {
            ...
            const mockTemplate = { id: 'tmpl-123', ...createDto, userId: mockUser.id };
            templatesService.create.mockResolvedValue(mockTemplate as any);

            const result = await controller.create(createDto, mockUser);

            expect(templatesService.create).toHaveBeenCalledWith(mockUser.id, createDto);
    ...
    describe('findOne', () => {
        it('should return template by id', async () => {
            ...
            expect(templatesService.findById).toHaveBeenCalledWith('tmpl-123', mockUser.id);
            expect(result).toEqual(mockTemplate);
        });
    });
    ...
    describe('update', () => {
        it('should update template', async () => {
            ...
            expect(templatesService.update).toHaveBeenCalledWith('tmpl-123', mockUser.id, updateDto);
    ...
    describe('remove', () => {
        it('should delete template', async () => {
            ...
            expect(templatesService.delete).toHaveBeenCalledWith('tmpl-123', mockUser.id);
        });
    });
    ...
    describe('createTask', () => {
        it('should create task from template', async () => {
            ...
            templatesService.createTaskFromTemplate.mockResolvedValue(mockTask as any);

            const result = await controller.createTask('tmpl-123', createDto, mockUser);
