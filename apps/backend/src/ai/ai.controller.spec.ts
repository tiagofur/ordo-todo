...
describe('AIController', () => {
    ...
    describe('parseTask', () => {
        it('should call parseNaturalLanguageTask with correct parameters', async () => {
            ...
            aiService.parseNaturalLanguageTask.mockResolvedValue(expectedResult as any);
    ...
    describe('getWellbeing', () => {
        it('should call getWellbeingIndicators with date range', async () => {
            ...
            const result = await controller.getWellbeing(mockUser, startDate, endDate);
    ...
    describe('suggestWorkflow', () => {
        it('should call suggestWorkflow with project details', async () => {
            ...
            const expectedResult = { phases: [], estimatedDuration: '2 weeks', tips: [] };
    ...
    describe('getProfile', () => {
        it('should return user AI profile', async () => {
            const expectedProfile = { peakHours: [9, 10, 11], avgSessionDuration: 25 };
    ...
    describe('getModelStats', () => {
        it('should return model usage statistics', () => {
            const expectedStats = { flash: 100, thinking: 10, estimatedCostSavings: '91%' };
