...
describe('CommentsService', () => {
    ...
    describe('create', () => {
        it('should create a comment and notify assignee', async () => {
            ...
            const createdComment = {
                ...
                taskId,
                authorId: userId,
                author: { id: userId, name: 'User 1', email: 'u1@example.com', image: null },
            };
            ...
            expect(mockActivitiesService.logCommentAdded).toHaveBeenCalledWith(taskId, userId, undefined);
        ...
        it('should notify mentioned users', async () => {
            ...
            expect(mockActivitiesService.logCommentAdded).toHaveBeenCalledWith(taskId, userId, ['User2']);
        });
    });
    ...
    describe('update', () => {
        it('should update a comment if author matches', async () => {
            ...
            expect(mockActivitiesService.logCommentEdited).toHaveBeenCalledWith('task-1', userId);
        ...
        it('should throw ForbiddenException if author does not match', async () => {
            ...
            await expect(service.update(commentId, dto, userId)).rejects.toThrow(ForbiddenException);
        });
    });
    ...
    describe('remove', () => {
        it('should delete a comment if author matches', async () => {
            ...
            expect(mockPrismaService.comment.delete).toHaveBeenCalledWith({ where: { id: commentId } });
            expect(mockActivitiesService.logCommentDeleted).toHaveBeenCalledWith('task-1', userId);
