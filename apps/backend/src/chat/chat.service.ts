...
import { ProductivityCoachService, CoachResponse } from './productivity-coach.service';
...
export class ChatService {
    ...
    async createConversation(
        ...
        const conversation = await this.chatRepository.createConversation({
            userId,
            title: dto.title,
            context: dto.workspaceId || dto.projectId
    ...
    async sendMessage(
        ...
        return {
            ...
            aiResponse: {
                ...
                metadata: assistantMessage.metadata as ChatMessageResponseDto['metadata'],
