...
describe('ChatController', () => {
    ...
    describe('getConversations', () => {
        it('should return paginated conversations', async () => {
            ...
            const result = await controller.getConversations(mockUser, '20', '0', 'false');
        ...
        it('should include archived when specified', async () => {
            chatService.getConversations.mockResolvedValue({ conversations: [], total: 0, limit: 20, offset: 0 } as any);
    ...
    describe('getConversation', () => {
        it('should return conversation by id', async () => {
            ...
            expect(chatService.getConversation).toHaveBeenCalledWith('conv-123', mockUser.id);
    ...
    describe('createConversation', () => {
        it('should create new conversation', async () => {
            ...
            expect(chatService.createConversation).toHaveBeenCalledWith(mockUser.id, dto);
            expect(result).toEqual(mockResult);
        });
    });
    ...
    describe('sendMessage', () => {
        it('should send message and return response', async () => {
            ...
            expect(chatService.sendMessage).toHaveBeenCalledWith('conv-123', mockUser.id, dto);
    ...
    describe('updateConversation', () => {
        it('should update conversation title', async () => {
            ...
            expect(chatService.updateTitle).toHaveBeenCalledWith('conv-123', mockUser.id, 'New Title');
        });
    });
    ...
    describe('archiveConversation', () => {
        it('should archive conversation', async () => {
            ...
            expect(chatService.archiveConversation).toHaveBeenCalledWith('conv-123', mockUser.id);
        });
    });
    ...
    describe('deleteConversation', () => {
        it('should delete conversation', async () => {
            ...
            expect(chatService.deleteConversation).toHaveBeenCalledWith('conv-123', mockUser.id);
        });
    });
    ...
    describe('getInsights', () => {
        it('should return productivity insights', async () => {
            const mockInsights = [
                { type: 'PEAK_HOUR', message: 'Best time to focus', priority: 'MEDIUM' },
            ];
