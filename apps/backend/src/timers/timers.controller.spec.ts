...
describe('TimersController', () => {
  ...
  beforeEach(async () => {
    ...
    timersService = module.get<TimersService>(
      TimersService,
    ) as jest.Mocked<TimersService>;
  });
  ...
  describe('getHistory', () => {
    it('should return session history', async () => {
      ...
      expect(timersService.getSessionHistory).toHaveBeenCalledWith(
        dto,
        mockUser.id,
      );
  ...
  describe('getStats', () => {
    it('should return timer statistics', async () => {
      ...
      expect(timersService.getTimerStats).toHaveBeenCalledWith(
        dto,
        mockUser.id,
      );
  ...
  describe('getTaskSessions', () => {
    it('should return sessions for specific task', async () => {
      ...
      expect(timersService.getTaskSessions).toHaveBeenCalledWith(
        taskId,
        mockUser.id,
      );
      expect(result).toEqual(mockSessions);
